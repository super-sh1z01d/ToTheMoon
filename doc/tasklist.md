# Пошаговый план разработки (ToTheMoon2)
...
- [x] I4 Инжест WebSocket (PumpPortal)
...
- [x] I5 Клиент Birdeye с TTL-кэшем
...
- [x] I6 Планировщик и Initial→Active
...
- [x] I7 Скоринг: метрики, EWMA, сохранение
...
- [x] I8 Админка: настройки весов и порогов
...
- [x] I9 UI: список токенов (минимум)
...
- [x] I10 Degrade до Archived + очистка истории
...
- [x] I11 Экспорт для бота (bot-config JSON)
