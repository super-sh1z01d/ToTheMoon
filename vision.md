...
- Понижение статуса до Archived
  - При низкой активности/скоре N последовательных проверок — `status=Archived`.

- Админка
  - Обновляет веса, альфу EWMA, пороги в `settings`; изменения вступают в силу без рестарта.
